...
/*
    ...
    [_NAVFUN] = LAYOUT_6x3_4(
                ...
                _______, DF(_QWERTY),    _______, _______, KC_CAPS, _______,     _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______,
                         DF(_COLMAK_DH), _______, _______, _______, _______,     _______, KC_END,  KC_PGDN, KC_PGUP, KC_HOME,
    ...
    [_SYMBOL] = LAYOUT_6x3_4(
                ...
                KC_TILDE,     KC_1,      KC_2,     KC_3,      KC_4,     KC_5,               KC_6,        KC_7,      KC_8,    KC_9,      KC_0,       KC_PIPE,
                            KC_DQT,   KC_UNDS,  KC_MINS,   KC_LCBR,  KC_LBRC,            KC_RBRC,     KC_RCBR,   KC_PLUS,  KC_EQL,   KC_QUOT,
                                     _______,     _______,   _______, _______,            _______,     _______,    _______,    _______
    ),
    /*
    [_SYMBOL] = LAYOUT_6x3_4(
